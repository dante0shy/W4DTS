...
from W4DTS.utils.pesudo_label_generator import (
    PesudoLabelGenerator_v9_8_rev_t as PesudoLabelGenerator,
)
                ...
                for i, batch_loader in enumerate(data_update.get_data_loader()):
                    ...
                    for idx, batch in enumerate(batch_loader):
                        ...
                        for pidx in range(predictions.C[:, 0].max() + 1):
                            ...
                            if sur_sv_feature.shape[0] and sur_sv_feature.shape[0] > 8000:
                            ...
                            if sur_sv_feature_list[pidx].shape[0]< 8000:
                                sample_idx = torch.randperm(mean_features.shape[0])[
                                             :8000 - sur_sv_feature_list[pidx].shape[0]
                                             ].long()
                            ...
                            # lgs[pidx] = sm_index.shape[0]
                            # print(trust_svm.shape)
