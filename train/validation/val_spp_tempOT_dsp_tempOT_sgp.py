...
# print(os.path.join(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),'ME_Squeeze')))
import torch
...
sv_base = os.path.join(data_base,'superV_v2')
...
snap = os.path.join(
    os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),
    "pretrained",
    "model-e-spp-tempOT-dsp-tempOT-sgp.pth",
)
